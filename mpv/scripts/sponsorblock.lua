-- sponsorblock.lua (vendored from mpv_sponsorblock_minimal)
--
-- Source:  https://codeberg.org/jouni/mpv_sponsorblock_minimal
-- License: GPLv3 — https://codeberg.org/jouni/mpv_sponsorblock_minimal/raw/branch/master/LICENSE
--
-- Skips sponsored segments of YouTube videos using data from
-- https://github.com/ajayyy/SponsorBlock
--
-- Press 'b' in mpv to toggle on/off.
