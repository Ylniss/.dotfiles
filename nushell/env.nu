...
if (is-windows) {
  ...
  for dir in ['C:\Program Files\Aseprite' 'C:\Program Files\Audacity' 'C:\Program Files\Inkscape\bin' 'C:\Program Files\GIMP 3\bin' $'($env.LOCALAPPDATA)\Programs\GIMP 3\bin'] {
    if ($dir | path exists) {
