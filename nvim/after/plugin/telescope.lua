...
local function telescope_find_files_in_repo()
	telescope.find_files({
		cwd = "~/stuff/repo/",
	})
end
...
vim.keymap.set("n", "<leader>sf", telescope_find_files, { desc = "search files" })
vim.keymap.set("n", "<leader>sp", telescope_find_files_in_repo, { desc = "search repo" })
